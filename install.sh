...
installTheme(){
    ...
    git clone https://github.com/Jasson44/Pterodactyl_Nightcore_Theme.git > /dev/null 2>&1
...
repair(){
    bash <(curl https://raw.githubusercontent.com/Jasson44/Pterodactyl_Nightcore_Theme/main/repair.sh)
}
